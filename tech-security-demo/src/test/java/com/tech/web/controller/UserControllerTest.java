...
public class UserControllerTest {
	...
	public void whenQuerySuccess() throws Exception {
		String result = mockMvc
				.perform(get("/user").param("userName", "kimi").param("password", "test@1234")
	...
	public void whenGetInfoSuccess() throws Exception {
		String result = mockMvc.perform(get("/user/1").contentType(MediaType.APPLICATION_JSON_UTF8))
				.andExpect(status().isOk()).andExpect(jsonPath("$.userName").value("Kimi")).andReturn().getResponse()
				.getContentAsString();
	...
	public void whenCreateSuccess() throws Exception {
		...
		String content = "{\"userName\":\"Kimi\",\"password\":null,\"birthday\":" + date.getTime() + "}";
	...
	public void whenUpdateSuccess() throws Exception {
		...
		String content = "{\"id\":\"1\",\"userName\":\"Kimi\",\"password\":null,\"birthday\":" + date.getTime() + "}";
	...
	public void whenDeleteSuccess() throws Exception {
		mockMvc.perform(delete("/user/100").contentType(MediaType.APPLICATION_JSON_UTF8)).andExpect(status().isOk());
	}
